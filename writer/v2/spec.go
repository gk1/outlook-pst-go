...
const (
	...
	SectionAttachmentTemplate = "2.4.6.1.1"
...
const (
	...
	// NIDAttachmentTable is the PST-wide empty Attachment Table Template.
	// See MS-PST 2.4.6.1.1.
	NIDAttachmentTable uint32 = 0x671
)
...
const (
	...
	PidTagPriority                     uint16 = 0x0026
	PidTagSensitivity                  uint16 = 0x0036
	...
	PidTagSenderAddressType            uint16 = 0x0C1E
	...
	ObjectTypeMailUser                 int32  = 6
	DisplayTypeMailUser                int32  = 0
	StoreSupportMaskUnicode            int32  = 0x00040E79
	EntryIDSize                               = 24
	MsgFlagRead                        int32  = 0x0001
